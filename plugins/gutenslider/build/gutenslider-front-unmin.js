...
const events = (swiper, method) => {
  let document = ssr_window_esm_getDocument();
  const {
    params,
    touchEvents,
    el,
...
class Gutenslider {
  ...
  initSwiper() {
    ...
    this.swiperInstance = new core(this.domSwiper, { ...this.swiperSettings,
      modules: [Navigation, Pagination, EffectCoverflow, EffectCube, EffectFade, EffectFlip, A11y, Autoplay, Lazy, Keyboard, History, HashNavigation],
      preloadImages: false,
      watchSlidesProgress: true,
